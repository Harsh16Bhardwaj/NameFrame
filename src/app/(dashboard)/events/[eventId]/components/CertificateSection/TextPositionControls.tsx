          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                value={fontSettings.size}
                onChange={(e) =>
                  onFontChange("size", parseInt(e.target.value) || 48)
                }
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                onChange={(e) =>
                  onPositionChange("x", parseInt(e.target.value))
                }
              ...
              <input
                ...
                value={textPosition.x}
                onChange={(e) =>
                  onPositionChange("x", parseInt(e.target.value) || 50)
                }
                className="w-16 rounded-md border border-[#4b3a70]/30 bg-[#232530] px-2 py-1 text-center text-sm text-[#c5c3c4]"
              />
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                onChange={(e) =>
                  onPositionChange("y", parseInt(e.target.value))
                }
                className="w-full accent-[#e5e1e8]"
              />
              <input
                ...
                value={textPosition.y}
                onChange={(e) =>
                  onPositionChange("y", parseInt(e.target.value) || 50)
                }
                className="w-16 rounded-md border border-[#4b3a70]/30 bg-[#232530] px-2 py-1 text-center text-sm text-[#c5c3c4]"
              />
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                onChange={(e) =>
                  onPositionChange("width", parseInt(e.target.value))
                }
                className="w-full accent-[#e5e1e8]"
              />
              <input
                ...
                value={textPosition.width}
                onChange={(e) =>
                  onPositionChange("width", parseInt(e.target.value) || 80)
                }
                className="w-16 rounded-md border border-[#4b3a70]/30 bg-[#232530] px-2 py-1 text-center text-sm text-[#c5c3c4]"
              />
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                onChange={(e) =>
                  onPositionChange("height", parseInt(e.target.value))
                }
                className="w-full accent-[#e5e1e8]"
              />
              <input
                ...
                value={textPosition.height}
                onChange={(e) =>
                  onPositionChange("height", parseInt(e.target.value) || 15)
                }
                className="w-16 rounded-md border border-[#4b3a70]/30 bg-[#232530] px-2 py-1 text-center text-sm text-[#c5c3c4]"
              />
            </div>
