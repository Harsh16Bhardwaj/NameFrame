  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full sm:w-64 bg-[#272936] border border-[#4b3a70]/30 rounded-lg py-2 pl-10 pr-4 text-sm text-[#c5c3c4] focus:outline-none focus:ring-1 focus:ring-[#b7a2c9]/50"
      />
    </div>
  );
}