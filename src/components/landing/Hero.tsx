    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
          ...
          >
            Upload, customize, and send — no design skills needed. Save hours with bulk certificate generation.
          </motion.p>
          ...
          >
            <SignedOut>
              <Link href="/signup">
                <button className="px-8 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 rounded-lg font-medium text-white shadow-lg hover:shadow-violet-500/25 transform hover:scale-105 transition duration-300">
            ...
            <button className="px-8 py-3 border border-gray-600 rounded-lg font-medium text-gray-300 hover:bg-white/5 transition duration-200">
              See How It Works
            </button>
          </motion.div>
        </div>
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-2xl md:text-3xl font-script text-black font-bold">
                      {previewName}
                    </div>
                  </div>
                </div>
              ...
              {templates.map((_, index) => (
                <button 
                  ...
                  className={`w-2 h-2 rounded-full transition-all ${
                    currentTemplate === index ? "bg-violet-500 w-6" : "bg-gray-600"
                  }`}
                  onClick={() => {}}
                />
              ))}
