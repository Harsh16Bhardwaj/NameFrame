...
export const CTA = () => {
  return (
    <motion.section
      className="py-16 flex justify-center items-center sm:py-24 min-h-[90vh] relative bg-[#101010] overflow-hidden" // Changed to a solid background to provide more contrast
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        <div className="absolute -bottom-1/4 -left-1/3 w-1/2 h-1/2 rounded-full bg-[#4eb3a3] blur-[100px]"></div>
      </motion.div>
