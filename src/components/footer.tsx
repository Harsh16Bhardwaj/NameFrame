...
function Footer() {
  return (
    <footer className=" border-t-2 border-gray-700  bottom-0  px-6 py-6 bg-gradient-to-r from-slate-900 via-gray-700 to-gray-900 text-white rounded-t-xl shadow-inner">
